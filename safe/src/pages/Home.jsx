      ...
      <main className="main">
          ...
          <div className="home__container  grid">
            <div className="home__data">
              ...
              <p className="home__description">
                EHMR is a secure blockchain based platform for storage of
        ...
        <section className="contact section container" id="contact">
            <div className="contact__container grid">
                ...
                <ul className="contact__content grid">
                    <li className="contact__address">Telephone: <span className="contact__information">+91 912321891</span>
                    </li>
                    <li className="contact__address">Email: <span
                            className="contact__information">vinutha2304@gmail.com</span></li>
                    <li className="contact__address">Location: <span className="contact__information">BITM - BALLARI
                            KARNATAKA 583101</span></li>
                </ul>
        ...
        <footer className="footer section">
          <p className="footer__copy">
            Design And Developed By Tech Builders
          </p>
          <p className="footer__copy">&#169; EHMR. All right reserved</p>
        </footer>
    </div>
  );
};
